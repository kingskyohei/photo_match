...
// クエリの実行
$query = "SELECT * FROM pm_user WHERE user_login = '" . $user_login . "'";
...
//予約テーブルから予約情報を取得する
$query_yoyaku ="SELECT * FROM yoyaku_table WHERE user_id = '" . $user_id . "'";

$result_yoyaku = $mysqli->query($query_yoyaku);
...
while ($row = $result_yoyaku->fetch_assoc()) {
  // パスワード(暗号化済み）の取り出し
        ...
        eventSources: [
            {
                events: [
                    ...
                    {
                        title: '<?php echo json_encode($yoyaku_title);?>件',
                        start: '2015-11-22',
                        allDay: false // will make the time show
                    }
                ]
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href=""><p>ようこそ<?=htmlspecialchars($_SESSION["USERID"], ENT_QUOTES); ?>さん</p></a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Title -->
            <div class="title">○○さんのページ</div>

            <!-- Preview Image -->
            <img class="img-responsive" src="./images/bg.jpg" alt="">
            ...
            <div class="well">
                ...
                <div class="request">
                    ...
                    <div class="apply_button">
                        <input class="btn btn-primary" type="button" name="apply" value="○○に申し込みを行う"/>
                    </div>
                </div>
            </div>
            <!-- Side Widget Well -->
