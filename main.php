...
// クエリの実行
$query = "SELECT * FROM pm_user WHERE user_id = '" . $mt_user_id . "'";
...
while ($row = $result->fetch_assoc()) {
  // パスワード(暗号化済み）の取り出し 
  $age = $row['age'];
  $mt_user_id = $row['user_id'];
}


//予約テーブルから予約情報を取得する
$query_yoyaku ="SELECT * FROM yoyaku_table WHERE user_id = '" . $mt_user_id . "'";
var_dump($query_yoyaku);
